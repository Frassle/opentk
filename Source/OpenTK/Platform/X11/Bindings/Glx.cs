    ...
    class Glx : Graphics.GraphicsBindingsBase
    {
        ...
        public partial class Arb
        {
            ...
            {            
                ...
                Silk.Cil.Ldc_I4(0);
                Silk.Cil.Ldelem_I();
                Silk.Cil.Calli(CallingConvention.Cdecl, typeof(IntPtr), typeof(IntPtr), typeof(IntPtr), typeof(IntPtr), typeof(byte), typeof(int*));
                Silk.Cil.Ret();
            ...
            {
                Silk.Cil.DeclareLocal("System.Int32& pinned", "attribs_pinned");
                if (attribs != null && attribs.Length != 0)
                {
                    Silk.Cil.Load(attribs);
                    Silk.Cil.Ldc_I4(0);
                    Silk.Cil.Ldelema<int>();
                    Silk.Cil.StoreByName("attribs_pinned");
                }
                ...
                Silk.Cil.Ldarg(2);
                Silk.Cil.Ldarg(3);
                Silk.Cil.LoadByName("attribs_pinned");
                Silk.Cil.Conv_I();
        ...
        public partial class Ext
        {
            ...
            public static ErrorCode SwapInterval(IntPtr display, IntPtr drawable, int interval)
            {
                ...
                Silk.Cil.Ldc_I4(1);
                Silk.Cil.Ldelem_I();
                Silk.Cil.Calli(CallingConvention.Cdecl, typeof(ErrorCode), typeof(IntPtr), typeof(IntPtr), typeof(int));
                Silk.Cil.Ret();
                throw new NotImplementedException();
            }
        }
        ...
        public partial class Mesa
        {
            ...
            public static ErrorCode SwapInterval(int interval)
            {
                ...
                Silk.Cil.Ldc_I4(2);
                Silk.Cil.Ldelem_I();
                Silk.Cil.Calli(CallingConvention.Cdecl, typeof(ErrorCode), typeof(int));
                Silk.Cil.Ret();
                throw new NotImplementedException();
            }
            ...
            public static int GetSwapInterval()
            {
                ...
                Silk.Cil.Ldc_I4(3);
                Silk.Cil.Ldelem_I();
                Silk.Cil.Calli(CallingConvention.Cdecl, typeof(int));
                Silk.Cil.Ret();
                throw new NotImplementedException();
            }
        }
